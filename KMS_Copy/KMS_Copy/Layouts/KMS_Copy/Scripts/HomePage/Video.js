...
var videoMgr = function () {
    ...
    self.CommentsTitle = ko.observable(SP2013.O365.currentLang() == '1033' ? 'Commnets' : '评论');
    ...
    self.CommentsPayBackDisplay = ko.observable(SP2013.O365.currentLang() == '1033' ? 'Replay' : '回复');
    ...
    self.InitCommentsCount = function () {
        ...
        SP2013.Utility.ReturnJson(SP2013.O365.postJSON(menthod, {
            weburl: SP2013.O365.currentWebAbsoluteUrl(),
