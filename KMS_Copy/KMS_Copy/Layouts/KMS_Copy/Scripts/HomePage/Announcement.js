/*通告实体*/
var announcementEntity = function (data) {
    var entity = this;
...
var announcementMgr = function () {
    ...
    self.Load = function () {
        ...
        var mehtod = "/_vti_bin/KMSServices/Global.svc/KMS/Announcement/Items";
        SP2013.Utility.ReturnJson(SP2013.O365.postJSON(mehtod, {
            ...
            if (d && d.length > 0) {
                ...
                $.each(d, function (i, item) {
                    self.DataAttr.push(new announcementEntity(item));
                });
    ...
    self.loadmore = function () {
        if (this.y == this.maxScrollY) {
            var method = "/_vti_bin/KMSServices/Global.svc/KMS/Announcement/Items";
