...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GlobalSearchCtrl.ascx.cs" Inherits="Envision.KMS.solution.ControlTemplates.Envision.KMS.Solution.GlobalSearchCtrl" %>
...
<script src="/_layouts/15/Envision.KMS.Solution/Scripts/HomePage/Header.js"></script>