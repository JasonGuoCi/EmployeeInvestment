...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AnnouncementCtrl.ascx.cs" Inherits="Envision.KMS.solution.ControlTemplates.Envision.KMS.Solution.HomePage.AnnouncementCtrl" %>
    ...
    <div class="content">
        ...
        <div id="announcement-content">
            <div id="scroller">
                ...
                <div style="text-align: center;"><a href="javascript:void();" data-bind="click: loadmore, visible: MoreVisible">MORE</a></div>
            </div>
        </div>

        <div class="link">
            <img src="/_layouts/15/Envision.KMS.Solution/Images/AnnoucementMenu.png" class="bg-img">
            <div class="circle div1" data-bind="click: Navigate2Page.bind($data, 'Wikipedia.aspx'), event: { mouseover: enablewiki, mouseout: disablewiki }">
                <img src="/_layouts/15/Envision.KMS.Solution/Images/Icon_circle.png" style="width: 100%; height: 100%;" data-bind="visible: WikiEnable" />
            </div>
            ...
            <div class="circle div2" data-bind="click: Navigate2Page.bind($data, 'Manual.aspx'), event: { mouseover: enablemanual, mouseout: disablemanual }">
                <img src="/_layouts/15/Envision.KMS.Solution/Images/Icon_circle.png" style="width: 100%; height: 100%;" data-bind="visible: ManualEnable" />
            </div>
            ...
            <div class="circle div3" data-bind="click: Navigate2Page.bind($data, 'ForumContent.aspx'), event: { mouseover: enableforum, mouseout: disableforum }">
                <img src="/_layouts/15/Envision.KMS.Solution/Images/Icon_circle.png" style="width: 100%; height: 100%;" data-bind="visible: ForumEnable" />
            </div>
...
<script src="/_layouts/15/Envision.KMS.Solution/Scripts/backstretch-ini.js"></script>
<script src="/_layouts/15/Envision.KMS.Solution/Scripts/jquery.nicescroll.min.js"></script>
<script src="/_layouts/15/Envision.KMS.Solution/Scripts/HomePage/Announcement.js?v=0.1"></script>
