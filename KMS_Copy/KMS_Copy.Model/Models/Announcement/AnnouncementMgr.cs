...
namespace KMS_Copy.Model.Models.Announcement
{
    public class AnnouncementMgr
    {
        ...
        public List<AnnouncementEntity> GetAnnouncements(PagingEntity obj)
        {
            ...
            if (!string.IsNullOrEmpty(obj.Search))
            {
                caml = SearchHelper.OrderBy(SearchHelper.Where(
                    SearchHelper.And(SearchHelper.Eq("Field_KMS_Status", SearchHelper.ValueType.Text, "Published"),
            ...
            {
                _rItems.Add(new AnnouncementEntity(item, obj.Language));
            }
            return _rItems;
        }
        /// <summary>
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public AnnouncementEntity GetAnnouncementItems(PagingEntity obj)
        {
        ...
        public int GetAnnouncementsCount(PagingEntity obj)
        {
            ...
            if (!string.IsNullOrEmpty(obj.Search))
            {
                caml = SearchHelper.Where(SearchHelper.And(
