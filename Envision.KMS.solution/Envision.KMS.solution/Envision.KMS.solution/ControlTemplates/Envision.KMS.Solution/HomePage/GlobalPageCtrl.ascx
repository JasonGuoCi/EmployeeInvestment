...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GlobalPageCtrl.ascx.cs" Inherits="Envision.KMS.solution.ControlTemplates.Envision.KMS.Solution.HomePage.GlobalPageCtrl" %>
<link rel="stylesheet" href="/_layouts/15/Envision.KMS.Solution/Global/styles/style.css">
<link href="/_layouts/15/Envision.KMS.Solution/Styles/bootstrap.css" rel="stylesheet" />
<!-- CSS Implementing Plugins -->
<link rel="stylesheet" href="/_layouts/15/Envision.KMS.Solution/Global/styles/animate.css">
<link rel="stylesheet" href="/_layouts/15/Envision.KMS.Solution/Global/styles/settings.css" type="text/css"
    media="screen">
<!--[if lt IE 9]>
    <link rel="stylesheet" href="/_layouts/15/Envision.KMS.Solution/Global/styles/settings-ie8.css" type="text/css"
          media="screen"><![endif]-->
            ...
            <ul data-bind="foreach: DataAttr">
                ...
                <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000"
                    ...
                    <div class="global-page-content">
                        ...
                        <div class="re-text-v1" data-bind="text: Description">
                        </div>
                        ...
                        <div data-bind="foreach: ContactAttr">
                            <div style="margin-bottom:10px;height:144px;">
                                ...
                                <div style="position: relative;margin-top:5px;"  data-bind="visible: Contact() || Extend3()">
                                    <img src="/_layouts/15/Envision.KMS.Solution/Images/profile.png" style="width: 25px; position: absolute; top: 5px; left: 5px;" />
...
<script src="/_layouts/15/Envision.KMS.Solution/Global/scripts/jquery.themepunch.tools.min.js"></script>
<script src="/_layouts/15/Envision.KMS.Solution/Global/scripts/jquery.themepunch.revolution.min.js"></script>
<script src="/_layouts/15/Envision.KMS.Solution/scripts/jquery.backstretch.min.js"></script>
<script src="/_layouts/15/Envision.KMS.Solution/Global/scripts/style-switcher.js"></script>
<script src="/_layouts/15/Envision.KMS.Solution/Global/scripts/revolution-slider.js"></script>
<script src="/_layouts/15/Envision.KMS.Solution/Scripts/HomePage/slidereveal.js"></script>
<script src="/_layouts/15/Envision.KMS.Solution/Global/scripts/app.js?v=0.1"></script>
<script type="text/javascript">
    jQuery(document).ready(function () {
        App.init();
        //StyleSwitcher.initStyleSwitcher();
        //RevolutionSlider.initRSfullWidth(1170,500);
